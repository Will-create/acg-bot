    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(route('aire_protegees.index')); ?>">Aires</a></li>
...
<?php $__env->startSection('content'); ?>
    <?php if(Route::currentRouteName() == 'aire_protegees.create'): ?>
        <form action="<?php echo e(route('aire_protegees.store')); ?>" method="post" enctype="multipart/form-data">
        <?php else: ?>
            <form action="<?php echo e(route('aire_protegees.update', $aire->uuid)); ?>" method="post" enctype="multipart/form-data">
                <?php echo method_field('PUT'); ?>
    <?php endif; ?>
    <?php echo csrf_field(); ?>
    <?php echo $__env->make('pages.backoffice.aire_protegees._form', ['btnAction' => $btnAction, 'aire' => $aire ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </form>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.master4', ['titrePage' => $titrePage], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views/pages/backoffice/aire_protegees/createdit.blade.php ENDPATH**/ ?>