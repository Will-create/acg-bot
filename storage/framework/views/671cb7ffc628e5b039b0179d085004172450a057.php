    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('type_unites.index')); ?>">Types d'unités</a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php echo e($btnAction); ?> un type d'unité</li>
            </ol>
        </div>
...
<?php $__env->startSection('content'); ?>
    <?php if(Route::currentRouteName() == 'type_unites.create'): ?>
        <form action="<?php echo e(route('type_unites.store')); ?>" method="post" enctype="multipart/form-data">
        <?php else: ?>
            <form action="<?php echo e(route('type_unites.update', $type->uuid)); ?>" method="post" enctype="multipart/form-data">
                <?php echo method_field('PUT'); ?>
    <?php endif; ?>
    <?php echo csrf_field(); ?>
    <?php echo $__env->make('pages.backoffice.type_unites._form', ['btnAction' => $btnAction, 'type' => $type ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </form>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master4', ['titrePage' => $titrePage], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views/pages/backoffice/type_unites/createdit.blade.php ENDPATH**/ ?>