                ...
                <div class="table-responsive ">
                    <table class="table row table-borderless table-sm">
                        <tbody class="col-lg-12 col-xl-6 p-2 ">
                            <tr>
                            <td><strong>Type d'unite :</strong><a  data-toggle="tooltip" data-placement="right" title="Cliquer pour afficher les détails" class="text-dark" href="<?php echo e(route('type_unites.show',$unite->type->uuid)); ?>"><?php echo e($unite->type->nom); ?></a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><strong>Administratutelle : </strong> <?php echo e($unite->administration_tutelle); ?></td>
                             </tr>
                        </tbody>
                        <tbody class="col-lg-12 col-xl-6 p-0">
                            ...
                            <tr>
                            <td><strong>Responsable : </strong> <a  data-toggle="tooltip" data-placement="right" title="Cliquer pour afficher les détails" class="text-dark" href="<?php echo e(route('utilisateurs.show',$unite->responsable->uuid)); ?>"><?php echo e($unite->responsable->nom); ?>   <?php echo e($unite->responsable->prenom); ?></a> </td>
                            </tr>
                        </tbody>
                    </table>
                </div>
...
<?php echo $__env->make('layouts.masterCarte', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views\pages\backoffice\unites\show.blade.php ENDPATH**/ ?>