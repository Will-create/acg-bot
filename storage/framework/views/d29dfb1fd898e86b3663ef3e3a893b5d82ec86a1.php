            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="poids" placeholder="Le poids en kg" id="poids"  value="<?php echo e($confiscation->poids); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="nombre" placeholder="Nombre" id="nombre"  value="<?php echo e($confiscation->nombre); ?>" required>
            ...
            <div class="row">
                <div class="col-md-6">
					<div class="form-group">
                        ...
                        <option <?php echo e($confiscation->crime_id == $crime->id ? 'selected' : ''); ?> value="<?php echo e($crime->id); ?>"><?php echo e($crime->paysApprehension->nom ?? ''); ?> <?php echo e($crime->service_investigateur->designation ?? ''); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" name="description" id="description"  value="<?php echo e(old('description')); ?>" required><?php echo e($confiscation->description); ?></textarea>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views\pages\backoffice\confiscations\edit.blade.php ENDPATH**/ ?>