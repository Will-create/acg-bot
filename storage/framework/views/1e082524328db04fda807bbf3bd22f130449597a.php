    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo e(ucfirst($localite->nom)); ?></li>
            </ol>
        </div>
        <div class="ml-auto pageheader-btn">
            <a class="btn btn-primary" href="<?php echo e(route('localites.index')); ?>"> <span>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="card-header">
                    <div class="float-left">
                        <div class="media-heading">
                            <h5><strong>Details de <?php echo e(ucfirst($localite->nom)); ?></strong></h5>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="card-body wideget-user-contact">
                    <strong>Pays :</strong> <a class="text-dark" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" href="<?php echo e(route('pays.show',$localite->pay->uuid)); ?>"> <?php echo e($localite->pay->nom); ?></a>
                    <br><br>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php $__currentLoopData = $unites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <a class="text-dark" href="<?php echo e(route('unites.show', $unite->uuid)); ?>" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <a href="<?php echo e(route('localites.index')); ?>" class="btn btn-dark"> <span>
                    <i class="fe fe-close"></i>
                </span><i class="fa fa-times"></i> Retour</a>

            <a href="<?php echo e(route('localites.edit', $localite->uuid)); ?>" class="btn btn-primary">
                <i class="fa fa-edit"></i> Modifier</a>
            <button type="button" class="btn btn-danger  mb-1" data-toggle="modal"
                data-target="#exampleModalDelete<?php echo e($localite->id); ?>"><i class="fa fa-trash"></i> Supprimer</button>
        </div>
    </div>

    <div class="modal" id="exampleModalDelete<?php echo e($localite->id); ?>" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalDelete" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalDelete">Suppression de <?php echo e($localite->nom); ?></h5>
                ...
                <div class="modal-footer">
                    <form action="<?php echo e(route('localites.destroy', $localite->uuid)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views/pages/backoffice/localites/show.blade.php ENDPATH**/ ?>