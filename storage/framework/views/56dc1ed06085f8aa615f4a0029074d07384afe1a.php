...
unset($__errorArgs, $__bag); ?>
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" placeholder="Code WDPA" name="code_wdpa_aire"  id="code_wdpa_aire"  value="<?php echo e(old('code_wdpa_aire') ?? $aire->code_wdpa_aire); ?>">
                             ...
                             <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nom_responsable" placeholder="Nom du responsable" id="libelle"  value="<?php echo e(old('nom_responsable') ?? ucfirst($aire->nom_responsable)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="prenom_responsable" placeholder="Prenom du responsable" id="prenom_responsable"  value="<?php echo e(old('prenom_responsable') ?? ucfirst($aire->prenom_responsable)); ?>">
...
unset($__errorArgs, $__bag); ?>
       ...
       <div class="modal-footer">
        ...
        </div><?php /**PATH D:\switch_maker\war_crimes\resources\views/pages/backoffice/aire_protegees/_form.blade.php ENDPATH**/ ?>