...
<div class="app-header header">
                    <div class="container-fluid">
                        <div class="d-flex">
                            <a class="header-brand d-md-none" href="<?php echo e(url('/' . $page='index')); ?>">
                                <img src="<?php echo e(URL::asset('assets/logo.jpeg')); ?>" class="header-brand-img mobile-icon" alt="logo">
                                <img src="<?php echo e(URL::asset('assets/logo.jpeg')); ?>" class="header-brand-img desktop-logo mobile-logo" alt="logo">
                            </a>
                                ...
                                <div class="dropdown profile-1">
                                    <a href="#" data-toggle="dropdown" class="nav-link pl-2 pr-2  leading-none d-flex">
                                        ...
                                        <div class="text-center mt-1 d-none d-xl-block">
                                            <h6 class="text-dark mb-0 fs-13 font-weight-semibold"><?php echo e(Auth::user()->nom. ' ' .Auth::user()->prenom); ?></h6>
                                        </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="<?php echo e(route('profil')); ?>">
                                            <i class="dropdown-icon mdi mdi-account-outline"></i> Profil
                                        </a>
                                    <a class="dropdown-item" href="<?php echo e(route('edit_password')); ?>">
                ...
                <!-- responsive-navbar -->
<?php /**PATH D:\Switch Maker\criminalite\resources\views\layouts\header.blade.php ENDPATH**/ ?>