...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if(Auth::user()->role->designation == 'Coordonnateur National'): ?>
                    <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <option value="<?php echo e($utilisateur->ville); ?>" selected > <?php echo e($utilisateur->ville->nom); ?></option>
...
<?php /**PATH D:\Switch Maker\criminalite\resources\views\pages\backoffice\administrateur\utilisateurs\form.blade.php ENDPATH**/ ?>