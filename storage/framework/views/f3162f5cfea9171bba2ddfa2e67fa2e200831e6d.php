...
} elseif ($_instance->childHasBeenRendered('fFh5Oyp')) {
    $componentId = $_instance->getRenderedChildComponentId('fFh5Oyp');
    $componentTag = $_instance->getRenderedChildComponentTagName('fFh5Oyp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fFh5Oyp');
} else {
    $response = \Livewire\Livewire::mount('crime');
    $html = $response->html();
    $_instance->logRenderedChild('fFh5Oyp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
