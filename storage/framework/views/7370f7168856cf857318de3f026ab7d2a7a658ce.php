            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="designation" placeholder="Dénomination" id="designation"  value="<?php echo e(old('designation') ?? $unite->designation); ?>" >
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control phone"  name="tel" placeholder="Téléphone" type="text"  value="<?php echo e(old('tel') ?? $unite->tel); ?>" >
                                    <?php $__errorArgs = ['tel'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select onchange="lier(this.value)" id="select"  name="pays_id" id="pays_id" class="form-control custom-select select2">
                            <option  value="<?php echo e(Route::currentRouteName() == 'unites.edit' ? $unite->pays->id : ''); ?>" selected ><?php echo e(Route::currentRouteName() == 'unites.edit' ? $unite->pays->nom : 'Sélectionner'); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="localite_id" id="localite_id" class="form-control custom-select select2">
                            <option value="<?php echo e(Route::currentRouteName() == 'unites.edit' ? $unite->localite->id : ''); ?>" selected ><?php echo e(Route::currentRouteName() == 'unites.edit' ? $unite->localite->nom.'______('.$unite->localite->pay->nom.')'  : 'Sélectionner'); ?></option>
                ...
                <div class="col-md-6">
					<div class="form-group">
                        ...
                        <select name="type_unite_id" id="type_unite_id" class="form-control custom-select select2">
                            <option value="<?php echo e(Route::currentRouteName() == 'unites.edit' ? $unite->type->id : ''); ?>" selected ><?php echo e(Route::currentRouteName() == 'unites.edit' ? $unite->type->nom : 'Sélectionner'); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="responsable_id" id="responsable_id" class="form-control custom-select select2">
                            <option  value="<?php echo e(Route::currentRouteName() == 'unites.edit' ? $unite->responsable->id : ''); ?>" selected ><?php echo e(Route::currentRouteName() == 'unites.edit' ? $unite->responsable->nom  : 'Sélectionner'); ?></option>
                        ...
                        <option  value="<?php echo e($responsable->id); ?>"> <span class="red-text">Nom:</span> <?php echo e($responsable->nom); ?> <?php echo e($responsable->prenom); ?> Pays:   
                            <?php echo e($responsable->pay->nom); ?> Role:
...
unset($__errorArgs, $__bag); ?>
    ...
    </script><?php /**PATH D:\Switch Maker\criminalite\resources\views\pages\backoffice\unites\_form.blade.php ENDPATH**/ ?>