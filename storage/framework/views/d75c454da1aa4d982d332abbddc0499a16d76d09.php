...
} elseif ($_instance->childHasBeenRendered('YnEiXQC')) {
    $componentId = $_instance->getRenderedChildComponentId('YnEiXQC');
    $componentTag = $_instance->getRenderedChildComponentTagName('YnEiXQC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YnEiXQC');
} else {
    $response = \Livewire\Livewire::mount('crime');
    $html = $response->html();
    $_instance->logRenderedChild('YnEiXQC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
