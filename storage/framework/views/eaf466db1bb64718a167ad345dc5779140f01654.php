...
} elseif ($_instance->childHasBeenRendered('RXBvsyv')) {
    $componentId = $_instance->getRenderedChildComponentId('RXBvsyv');
    $componentTag = $_instance->getRenderedChildComponentTagName('RXBvsyv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RXBvsyv');
} else {
    $response = \Livewire\Livewire::mount('regne-espece', ['crime'  => $crime]);
    $html = $response->html();
    $_instance->logRenderedChild('RXBvsyv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                             <br>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views/pages/backoffice/crimes/show.blade.php ENDPATH**/ ?>