...
<?php $__env->startSection('page-header'); ?>
    ...
    <div class="page-header">
        <div>
            ...
            <li class="breadcrumb-item"  > <a href="<?php echo e(route('especes.index')); ?>">Especes</a>  </li>

                <?php if(Route::currentRouteName() == 'especes.create'): ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(Route::currentRouteName() == 'especes.create'): ?>
        <form action="<?php echo e(route('especes.store')); ?>" method="post" enctype="multipart/form-data">
        <?php else: ?>
            <form action="<?php echo e(route('especes.update', $espece->uuid)); ?>" method="post" enctype="multipart/form-data">
                <?php echo method_field('PUT'); ?>
    <?php endif; ?>
    <?php echo csrf_field(); ?>
    <?php echo $__env->make('pages.backoffice.especes._form', ['btnAction' => $btnAction, 'unite' => $espece], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </form>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.master4', ['titrePage' => $titrePage], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\switch_maker\war_crimes\resources\views/pages/backoffice/especes/createdit.blade.php ENDPATH**/ ?>