				...
				<div class="row">
					<div class="col-md-12 col-lg-12">
						<div class="card">
                            ...
                            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('localites')->html();
} elseif ($_instance->childHasBeenRendered('x3AO1Cm')) {
    $componentId = $_instance->getRenderedChildComponentId('x3AO1Cm');
    $componentTag = $_instance->getRenderedChildComponentTagName('x3AO1Cm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('x3AO1Cm');
} else {
    $response = \Livewire\Livewire::mount('localites');
    $html = $response->html();
    $_instance->logRenderedChild('x3AO1Cm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
							<!-- TABLE WRAPPER -->
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\switch_maker\war_crimes\resources\views/pages/backoffice/localites/index.blade.php ENDPATH**/ ?>