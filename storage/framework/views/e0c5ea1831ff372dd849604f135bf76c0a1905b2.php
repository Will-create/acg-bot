            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nom" placeholder="Nom" id="nom"  value="<?php echo e(old('nom')?? $pays->nom); ?>" required>
                        <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?>
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="codeiso3_pays_origine" placeholder="Code ISO" id="codeiso3_pays_origine"  value="<?php echo e(old('codeiso3_pays_origine') ?? $pays->codeiso3_pays_origine); ?>" required>
...
<?php /**PATH D:\Switch Maker\criminalite\resources\views\pages\backoffice\pays\_form.blade.php ENDPATH**/ ?>