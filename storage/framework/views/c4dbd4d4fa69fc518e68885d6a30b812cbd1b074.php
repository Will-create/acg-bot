...
} elseif ($_instance->childHasBeenRendered('lI879sz')) {
    $componentId = $_instance->getRenderedChildComponentId('lI879sz');
    $componentTag = $_instance->getRenderedChildComponentTagName('lI879sz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lI879sz');
} else {
    $response = \Livewire\Livewire::mount('reglement', ['modeReglements'  => $modeReglements, 'suites'   => $suites, 'crime' => $crime]);
    $html = $response->html();
    $_instance->logRenderedChild('lI879sz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
						</div>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views/pages/backoffice/regelements/create.blade.php ENDPATH**/ ?>