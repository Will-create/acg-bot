                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <label for="terrorisme">
                                <input type="radio"  <?php if(!$auteur->terrorisme || $auteur->terrorisme == 0): ?> checked <?php endif; ?>   name="terrorisme" id="cnib" value="0">
                                Non
                            </label>
                            <label for="passport">
                                <input type="radio" <?php if($auteur->terrorisme && $auteur->terrorisme == 1): ?> checked <?php endif; ?> name="terrorisme" value="1">
                                Oui
                        </div>
                    </div>
                    <?php $__errorArgs = ['education'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea rows="5" type="text" class="form-control" name="adresse"
                            ...
                            ><?php echo e(old('adresse') ?? $auteur->adresse); ?></textarea>
