...
<form action="<?php echo e(route('confiscations.store')); ?>" method="post" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="crime" value="<?php echo e($crime); ?>">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="poids" placeholder="Le poids en kg" id="poids"  value="<?php echo e(old('poids')); ?>"  >
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="nombre" placeholder="Nombre" id="nombre"  value="<?php echo e(old('nombre')); ?>"  >
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="4" name="description" id="description"  value="<?php echo e(old('description')); ?>"></textarea>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/louisbertson/Desktop/criminalite/resources/views/pages/backoffice/confiscations/form.blade.php ENDPATH**/ ?>