...
<?php $__env->startSection('page-header'); ?>
				...
				<div class="page-header">
                    ...
                    <a class="btn btn-primary" href="<?php echo e(route('crime_auteurs.create')); ?>">  <span>
									...
									<table id="data-table1" class="table table-striped table-bordered text-nowrap w-100 table-sm">
										...
										<tbody>
											...
											<tr>
												...
												<td> <a class="text-dark" href="<?php echo e(route('crime_auteurs.show',  $auteur->uuid)); ?>" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" > <?php echo e($auteur->nom); ?></a></td>
												<td> <a class="text-dark" href="<?php echo e(route('crime_auteurs.show',  $auteur->uuid)); ?>" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" ><?php echo e($auteur->prenom); ?></a></td>
												<td> <a class="text-dark" href="<?php echo e(route('crime_auteurs.show',  $auteur->uuid)); ?>" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" ><?php echo e($auteur->genre); ?></a></td>
												<td> <a class="text-dark" href="<?php echo e(route('crime_auteurs.show',  $auteur->uuid)); ?>" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" > <?php echo e($auteur->pays->nom); ?>/<?php echo e($auteur->localite->nom); ?></a></td>
                                            </tr>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views/pages/backoffice/auteurs/index.blade.php ENDPATH**/ ?>