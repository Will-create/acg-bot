                ...
                <div class="table-responsive">
                    <table id="data-table1" class="table table-striped table-bordered text-nowrap w-100 table-sm">
                        ...
                        $crimeEspeces =  \App\Models\CrimeEspece::latest()->where('crime_id', $crime->id)->get()
                            ...
                            <tr>
                                <td><?php echo e($i++); ?></td>
                                 <td> <a class="text-dark" href="<?php echo e(route('crimes.show', $crime->uuid)); ?>">
                                    <?php $__currentLoopData = $crime->especes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $especeImplique): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!$loop->last): ?>
                                    <?php echo e($especeImplique->nom . ' , '); ?>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\switch_maker\war_crimes\resources\views/pages/backoffice/crimes/index-agent.blade.php ENDPATH**/ ?>