...
} elseif ($_instance->childHasBeenRendered('Wfd5fUn')) {
    $componentId = $_instance->getRenderedChildComponentId('Wfd5fUn');
    $componentTag = $_instance->getRenderedChildComponentTagName('Wfd5fUn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Wfd5fUn');
} else {
    $response = \Livewire\Livewire::mount('regne-espece', ['crime'  => $crime]);
    $html = $response->html();
    $_instance->logRenderedChild('Wfd5fUn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                             <br>
