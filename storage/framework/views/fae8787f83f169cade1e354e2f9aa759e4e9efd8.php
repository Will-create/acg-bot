...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                          ...
                          <?php if(Auth::user()->role->designation == 'Administrateur Général' || Auth::user()->role->designation == 'Coordonnateur Régional'): ?>
                        ...
                        <option  id="<?php echo e($pay->id); ?>" value="<?php echo e($pay->id); ?>"><?php echo e($pay->nom); ?></option>
                          ...
                          <?php else: ?>
                    <input type="hidden" name="pays_id" class="form-control" value="<?php echo e(Auth::user()->pay->id); ?>">
                    <input type="text"   class="form-control" value="<?php echo e(Auth::user()->pay->nom); ?>" readonly>
                          <?php endif; ?>
...
<?php $__currentLoopData = Auth::user()->pay->localites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localiter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($localiter->id); ?>"><?php echo e($localiter->nom); ?></option>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\switch_maker\war_crimes\resources\views/pages/backoffice/unites/_form.blade.php ENDPATH**/ ?>