                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php $__currentLoopData = $aires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a class="text-dark" href="<?php echo e(route('aire_protegees.show', $aire->uuid)); ?>" data-toggle="tooltip" data-placement="right" title="Cliquer pour afficher les détails">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalDelete">Suppression de <?php echo e($pays->designation); ?></h5>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/louisbertson/Desktop/criminalite/resources/views/pages/backoffice/pays/show.blade.php ENDPATH**/ ?>