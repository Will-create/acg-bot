...
<a  <?php if($utilisateur->id != Auth::user()->id): ?>   href="<?php echo e(route('gerer-utilisateur', $utilisateur)); ?>" <?php endif; ?>  class="btn btn-success mt-1 mb-1 btn-sm" data-toggle="tooltip" data-placement="top" title="Cliquer pour désactiver" > <i class="zmdi zmdi-rss text-white"></i> Compte  activé </a>

<?php else: ?>

<a  <?php if($utilisateur->id != Auth::user()->id): ?>   href="<?php echo e(route('gerer-utilisateur', $utilisateur)); ?>" <?php endif; ?>   class="btn btn-danger mt-1 mb-1 btn-sm" data-toggle="tooltip" data-placement="top" title="Cliquer pour activer"  > <i class="zmdi zmdi-rss text-white"></i>  Compte désacivé </a>
<?php endif; ?>
                                        ...
                                        <div class="table-responsive ">
                                            <table class="table row table-borderless">
                                                <tbody class="col-lg-12 col-xl-6 p-0">
                                                    ...
                                                    <tr>
                                                        <td><strong>Unité :</strong> <?php echo e($utilisateur->unite->nom); ?></td>
                                                        </tr>
                                                    <?php else: ?>
                                                ...
                                                <tbody class="col-lg-12 col-xl-6 p-0">
                                                    ...
                                                    <tr>
                                                        <td><strong>Téléphone :</strong> <?php echo e(formatel($utilisateur->tel)); ?> </td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>Fonction :</strong> <?php echo e(formatel($utilisateur->titre)); ?> </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views\pages\backoffice\administrateur\utilisateurs\show.blade.php ENDPATH**/ ?>