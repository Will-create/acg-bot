...
<form action="<?php echo e(route('utilisateurs.update', $utilisateur)); ?>" method="post" enctype="multipart/form-data">
    ...
    <a href="<?php echo e(URL::previous()); ?>" class="btn btn-secondary"> <span>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\switch_maker\war_crimes\resources\views/pages/backoffice/administrateur/utilisateurs/edit.blade.php ENDPATH**/ ?>