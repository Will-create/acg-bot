...
} elseif ($_instance->childHasBeenRendered('1bQOBPX')) {
    $componentId = $_instance->getRenderedChildComponentId('1bQOBPX');
    $componentTag = $_instance->getRenderedChildComponentTagName('1bQOBPX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1bQOBPX');
} else {
    $response = \Livewire\Livewire::mount('reglement', ['modeReglements'  => $modeReglements, 'suites'   => $suites, 'crime' => $crime]);
    $html = $response->html();
    $_instance->logRenderedChild('1bQOBPX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
						</div>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/louisbertson/Desktop/criminalite/resources/views/pages/backoffice/regelements/create.blade.php ENDPATH**/ ?>