				...
				<div class="page-header">
                    ...
                    <h1 class="page-title">Details aires protégées</h1>
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('accueil')); ?>">Accueil</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span class="text-dark">Détails </span><?php echo e($aire->libelle); ?></li>
                ...
                <div class="table-responsive ">
                    <table class="table row table-borderless">
                        <tbody class="col-lg-12 col-xl-6 p-0">
                            <tr>
                            <td><strong>Pays : </strong> <?php echo e($aire->pays->nom); ?></td>
                            </tr>
                            <tr>
...
<div class="row">
    ...
    <div class="col-md-6 mb-4">
        ...
        <button type="button" class="btn btn-danger  mb-1" data-toggle="modal"
            data-target="#exampleModalDelete<?php echo e($aire->id); ?>"><i class="fa fa-trash"></i></button>
    </div>
</div>
