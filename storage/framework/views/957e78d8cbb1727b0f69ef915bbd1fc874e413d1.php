				...
				<div class="page-header">
                    ...
                    <h1 class="page-title">Details aires protégées</h1>
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo e(route('accueil')); ?>">Accueil</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><span class="text-dark"></span><?php echo e($titrePage); ?></li>
...
<?php echo $__env->make('layouts.masterCarte', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\switch_maker\war_crimes\resources\views/pages/backoffice/aire_protegees/show.blade.php ENDPATH**/ ?>