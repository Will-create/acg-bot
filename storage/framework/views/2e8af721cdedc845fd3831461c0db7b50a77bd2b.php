...
<?php $__env->startSection('page-header'); ?>
				...
				<div class="page-header">
					<div>
						<h1 class="page-title" id="page-title">Liste des aires protégées dans <?php echo e($pay->nom); ?></h1>
						<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Aires protégées dans <?php echo e($pay->nom); ?></li>
						</ol>
					</div>
					<div class="ml-auto pageheader-btn">
                    <a class="btn btn-primary" href="<?php echo e(route('aire_protegees.create')); ?>"  >  <span>
                            <i class="fe fe-plus"></i>
                        </span>
						Ajouter une aire protégée</a>
						<a class="btn btn-primary" href="<?php echo e(URL::previous()); ?>"  >  <span>
							...
							<div class="col-lg-9">
								<div class="row">
									...
									<div class="col-md-12 col-lg-12">
										<div class="card">
											<div class="card-header">
												<h3 class="card-title">Les aires protégées de <?php echo e($pay->nom); ?> </h3>
											</div>
											<div class="card-body">
												<div class="table-responsive">
													<table id="data-table1" class="table table-striped table-bordered text-nowrap w-100 table-sm">
														...
														<tbody id="tableBody">
															<?php $__currentLoopData = $aires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aire): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<tr>
																<td> <a class="text-dark" href="<?php echo e(route('aire_protegees.show', $aire->uuid)); ?>"  data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails"> <?php echo e($aire->libelle); ?> </a></td>
																<td> <a class="text-dark" href="<?php echo e(route('aire_protegees.show', $aire->uuid)); ?>"  data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails"> <?php echo e($aire->pays->nom); ?> </a></td>
																<td> <a class="text-dark" href="<?php echo e(route('aire_protegees.show', $aire->uuid)); ?>"  data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails"><?php echo e($aire->code_wdpa_aire); ?></a></td>
																<td> <a class="text-dark" href="<?php echo e(route('aire_protegees.show', $aire->uuid)); ?>"  data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails"><?php echo e(substr($aire->adresse,0,25)); ?></a></td>
																<td> <a class="text-dark" href="<?php echo e(route('aire_protegees.show', $aire->uuid)); ?>"  data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails"><?php echo e($aire->tel); ?></a></td>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</tbody>
													</table>
												</div>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Switch Maker\criminalite\resources\views\pages\backoffice\aire_protegees\filter.blade.php ENDPATH**/ ?>