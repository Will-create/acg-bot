				...
				<div class="page-header">
					<div>
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a href="<?php echo e(route('armes.index')); ?>">Armes de crime</a></li>
							<li class="breadcrumb-item active" aria-current="page"><?php echo e($arme->nom); ?></li>
						</ol>
					</div>
					<div class="ml-auto pageheader-btn">
                        <a class="btn btn-primary" href="<?php echo e(route('crimes.show', $arme->crime ? $arme->crime->uuid : $crimeUuid)); ?>"> <span>
