										...
										<tbody>
											...
											<tr>
												...
												<td> <a class="text-dark" href="<?php echo e(route('commentaires.show',  $commentaire->uuid)); ?>" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" > <?php echo e($commentaire->destinataire->nom); ?> <?php echo e($commentaire->destinataire->prenom); ?>(<?php echo e($commentaire->destinataire->role->designation); ?>) </a></td>
												 <td> <a class="text-dark" href="<?php echo e(route('commentaires.show',  $commentaire->uuid)); ?>" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" ><?php echo e($commentaire->crime->localite_apprehension); ?></a></td>
...
<?php echo $__env->make('layouts.master4', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/louisbertson/Desktop/criminalite/resources/views/pages/backoffice/commentaires/index.blade.php ENDPATH**/ ?>