            ...
            <div class="tab-pane active show" id="tab-56">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $localites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
