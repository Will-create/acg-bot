    ...
    public function run()
    {
        ...
        for ($i=0; $i <10 ; $i++) {
            Espece::create([
                'nom'                   => $faker->name,
                'uuid'                  => Str::uuid(),
                'photo'                 => 'images/'.$faker->file($sourceDir = '/home/louisbertson/Desktop/criminalite/public/espece_vegetal', $targetDir = '/home/louisbertson/Desktop/criminalite/public/storage/images', false),
                'famille'               => $faker->name,
                'regne'                 =>'végétal',
