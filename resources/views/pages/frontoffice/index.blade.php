...
<br>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
					<div class="card overflow-hidden">
						<div class="card-header">
							<h3 class="card-title">Total des espèces {{ $total_especes}}</h3>
						</div>
						<div class="card-body">
							<div class="mb-5">
								<p class="mb-2">Espèces Animales<span class="float-right"><b>{{ $total_especeanimaux}}</b><span class="text-muted ml-1">({{ $percent_especeanimaux }}%)</span></span></p>
								<div class="progress h-2">
									<div class="progress-bar bg-primary w-{{ $percent_especeanimaux }} " role="progressbar"></div>
								</div>
							</div>
							<div class="mb-5">
								<p class="mb-2">Espèces Végétales<span class="float-right"><b>{{ $total_especevegetaux}}</b><span class="text-muted ml-1">({{ $percent_especevegetaux }}%)</span></span></p>
								<div class="progress h-2">
									<div class="progress-bar bg-secondary w-{{ $percent_especevegetaux }} " role="progressbar"></div>
								</div>
							</div>
							<br>
						</div>
					...
					<div class="card">
						<div class="card-body">
							<div class="row mb-1">
								<div class="col">
									<p class="mb-1">Pays</p>
									<h3 class="mb-0 number-font">{{ count($pays) }}</h3>
								</div>
							...
							<span class="fs-12 text-muted">Les <strong>{{ count($pays) }}</strong> <span class="text-muted fs-12 ml-0 mt-1">pays de l'Afrique de l'Ouest</span></span>
						</div>
					</div>
				</div>
				<div class="col-xl-3 col-sm-6">
						...
						<div class="card-body">
							<div class="row mb-1">
								<div class="col">
									...
									<h3 class="mb-0 number-font">{{ $total_aires }}</h3>
								</div>
								<div class="col-auto mb-0">
						...
						<div class="card-body">
							<div class="row mb-1">
								<div class="col">
									...
									<h3 class="mb-0 number-font">{{ $total_unites }}</h3>
								</div>
								<div class="col-auto mb-0">
						...
						<div class="card-body">
							<div class="row mb-1">
								<div class="col">
									...
									<h3 class="mb-0 number-font">{{ $agents }}</h3>
								</div>
								<div class="col-auto mb-0">
