			...
			<div class="row">
					...
					<div class="card">
						<div class="row">
							...
							<div class="col-md-12 col-lg-6  d-none d-lg-block">
								<img src="{{URL::asset('assets/images/media/1.jpg')}}" alt="img" class="cover-image w-100">
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-12">
					<div class="card">
						<div class="row">
							<div class="col-md-12 col-lg-6 d-none d-lg-block">
								<img src="{{URL::asset('assets/images/media/2.jpg')}}" alt="img" class="cover-image w-100">
							</div>
							<div class="col-md-12 col-lg-6 pr-0">
								<div class="card-body">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-lg-6 col-xl-3">
					<div class="card text-center">
						<img src="{{URL::asset('assets/images/media/1.jpg')}}" alt="img" class="br-tl-5 br-tr-5">
						<div class="card-body">
				...
				<div class="col-md-12 col-sm-12 col-lg-6 col-xl-3">
					<div class="card text-center">
						<img src="{{URL::asset('assets/images/media/2.jpg')}}" alt="img" class="br-tl-5 br-tr-5">
						<div class="card-body">
				...
				<div class="col-md-12 col-sm-12 col-lg-6 col-xl-3">
					<div class="card text-center">
						<img src="{{URL::asset('assets/images/media/6.jpg')}}" alt="img" class="br-tl-5 br-tr-5">
						<div class="card-body">
				...
				<div class="col-md-12 col-sm-12 col-lg-6 col-xl-3">
					<div class="card text-center">
						<img src="{{URL::asset('assets/images/media/7.jpg')}}" alt="img" class="br-tl-5 br-tr-5">
						<div class="card-body">
