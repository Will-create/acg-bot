                ...
                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="genre" id="genre" class="form-control custom-select select2">
                                    <option  value="{{Route::currentRouteName() == 'crime_auteurs.edit' ? $commentaire->genre : '' }}" {{Route::currentRouteName() == 'crime_auteurs.edit' ? '' : 'disabled' }} selected>{{Route::currentRouteName() == 'crime_auteurs.edit' ? $auteur->genre : 'Sélectionner' }}</option>
