...
@section('page-header')
				...
				<div class="page-header">
					<div>
						<h1 class="page-title">Les messages à valider</h1>
						<ol class="breadcrumb">
									...
									<table id="data-table1" class="table table-striped table-bordered text-nowrap w-100 table-sm">
										...
										<tbody>
											...
											<tr>
												...
												<td> <a class="text-dark" href="{{route('commentaires.show',  $commentaire->uuid)}}" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" > {{$message->auteur->nom}} {{$message->auteur->prenom}}({{$message->auteur->role->designation}}) </a></td>
												 <td> <a class="text-dark" href="{{route('commentaires.show',  $commentaire->uuid)}}" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" >{{$message->sms->uuid}}</a></td>
												<td> <a class="text-dark" href="{{route('commentaires.show',  $commentaire->uuid)}}" data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" > {{substr($message->commentaire, 0, 60) }} </a></td>
                                            </tr>
                                            @endforeach
										</tbody>
									</table>
