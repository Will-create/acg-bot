                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="float-left">
                                <h3 class="card-title">Message de  <a class="text-dark" href="{{route('utilisateurs.show',$commentaire->auteur->uuid)}}">{{$message->user_id->nom}} {{$message->user_id->prenom}}</a></h3>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="wideget-user text-center">
                                        <div class="wideget-user-desc">
                                            ...
                                            <div class="user-wrap">
                                                <a class="text-dark" href="{{ route('utilisateurs.show', $message->user_id->id) }}" data-toggle="tooltip" data-placement="top" title="Cliquer pour voir les details">
                                                    <h6 class="text-muted mb-4">{{$message->user_id->nom. ' ' . $message->user_id->prenom}} ({{$message->user_id->role->designation}})</h6>
                                                </a> <br>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="wideget-user-desc">
                                            ...
                                            <div class="user-wrap">
                                                    Contenu d'origine : <h6 class="mb-1">{{$message->user_id->nom}}</h6>
                                                 <br>
                                            </div>
                                        </div>
                                        <dt>Message:</dt>
                                        <h6 class="text-muted mb-4">Envoyé le : {{formatDate($message->created_at)}}</h6>
                                        <dd>  <a class="text-dark" href="{{route('messages.show', $message->id)}}">{{ucFirst($message->content)}}</a></dd>
                                    </div>
                                </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="tab-content">
                        <div class="tab-pane active show" id="tab-51">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="page-title">Autres message  de la même rubrique</h3>
                                    @foreach($autres as $autre)
                                    @if ($autre->id != $message->id)
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalDelete">Suppression de {{ $message->id }}</h5>
