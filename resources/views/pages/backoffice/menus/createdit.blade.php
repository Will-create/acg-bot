    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('menus.index') }}">Rubrique</a></li>
...
@section('content')
    ...
    @endif
    @csrf
    @include('pages.backoffice.menus._form', ['btnAction' => $btnAction, 'menu' => $menu ])
    </form>
@stop
{{-- CODE JS DE FILTRAGE --}}
@section('js')
