...
@section('page-header')
				...
				<div class="page-header">
					<div>
						...
						<li class="breadcrumb-item active" aria-current="page">Types de menu</li>
						</ol>
					</div>
					<div class="ml-auto pageheader-btn">
                    <a class="btn btn-primary" href="{{route('type_menus.create')}}">  <span>
                            <i class="fe fe-plus"></i>
                        </span>
                        Ajouter un type de menu</a>
                    </button>
					</div>
				</div>
				<!-- PAGE-HEADER END -->
					...
					<div class="col-md-12 col-lg-12">
						<div class="card">
							<div class="card-header">
								<h3 class="page-title">Liste des types de menu</h3>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table id="data-table1" class="table table-striped table-bordered text-nowrap w-100 table-sm">
										...
										<tbody>
											...
											<tr>
												<td> <a data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" class="text-dark" href="{{route('type_menus.show', $type->uuid)}}"> {{ucfirst($type->nom)}} </a></td>
												<td> <a data-toggle="tooltip" data-placement="top" title="Cliquer pour afficher les détails" class="text-dark" href="{{route('type_menus.show', $type->uuid)}}"> {{ substr($type->description, 0, 60) }}</a></td>
                                            </tr>
                                            @endforeach
										</tbody>
									</table>
