                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="pays_id" id="pays_id" class="form-control custom-select select2">
                            <option value="{{Route::currentRouteName() == 'unites.edit' ? $espece->pays->id : '' }}" selected >{{Route::currentRouteName() == 'unites.edit' ? $espece->pays->nom : 'Sélectionner' }}</option>
                ...
                <div class="col-md-6">
					...
					<div class="form-group">
                        ...
                        <select name="type" id="type" class="form-control custom-select select2">
                            <option value="{{Route::currentRouteName() == 'unites.edit' ? $espece->type->id : '' }}" selected >{{Route::currentRouteName() == 'unites.edit' ? $espece->type->nom : 'Sélectionner' }}</option>
