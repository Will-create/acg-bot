            ...
            <div class="card-body wideget-user-contact">
                ...
                <a href="{{ route('pays.show',$pays->uuid) }}">
                    <div class="card">
                        ...
                        <div class="card-body wideget-user-contact">
                            <img src="{{asset('storage').'/'.$pays->icone}}"
    ...
    <div class="tab-pane active show" id="tab-52">
        <div class="card">
            <div class="card-body">
                ...
                <a class="text-dark" href="{{ route('unites.show', $unite->uuid) }}" data-toggle="tooltip"
    ...
    <div class="tab-pane active show" id="tab-54">
        <div class="card">
            <div class="card-body">
                ...
                <a class="text-dark" href="{{ route('aire_protegees.show', $aire->uuid) }}" data-toggle="tooltip"
                    data-placement="right" title="Cliquer pour afficher les détails">
