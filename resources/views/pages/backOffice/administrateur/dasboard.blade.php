						...
						<div class="card-body">
							<div class="activity-block">
								<ul class="task-list user-tasks">
									<li>
										<span class="avatar avatar-md brround cover-image task-icon1" data-image-src="{{URL::asset('assets/images/users/1.jpg')}}"></span>
									...
									<li>
										<span class="avatar avatar-md brround cover-image task-icon1" data-image-src="{{URL::asset('assets/images/users/2.jpg')}}"></span>
									...
									<li>
										<span class="avatar avatar-md brround cover-image task-icon1" data-image-src="{{URL::asset('assets/images/users/8.jpg')}}"></span>
									...
									<li>
										<span class="avatar avatar-md brround cover-image task-icon1" data-image-src="{{URL::asset('assets/images/users/9.jpg')}}"></span>
				...
				<div class="col-sm-12 col-md-12 col-lg-4 col-xl-4">
					<div class="card">
						...
						<div class="customer-scroll">
							...
							<div class="list-group-item d-flex  align-items-center border-left-0 border-right-0">
								<div class="mr-2">
									<span class="avatar avatar-md brround cover-image" data-image-src="{{URL::asset('assets/images/users/7.jpg')}}"></span>
								</div>
								<div class="">
