    ...
    <div class="page-header">
        <div>
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('menus.index') }}">Compétition</a></li>
        ...
        <div class="ml-auto pageheader-btn">
            <a class="btn btn-primary" href="{{ route('menus.index') }}"> <span>
                ...
                </span> Toutes les Compétitions</a>
            </button>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
...
@section('content')
    @if (Route::currentRouteName() == 'menus.create')
        ...
        @else
            <form action="{{ route('competitions.update', $menu->uuid) }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @endif
                @csrf
            </form>
