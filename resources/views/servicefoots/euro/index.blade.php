                        ...
                        <div class="page-header">
                            ...
                            <h1 class="page-title text-dark">Details d 'application</h1>
                                ...
                                <li class="breadcrumb-item"><a href="{{route('servicefoot.index')}}">ServiceFoot</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><span class="text-dark"></span>EURO</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
@section('content')
                            ...
                            <h3> Messages entrants</h3> <hr>
                                <div class="scrollss">
                                    ...
                                    <button class="btn button1 " onclick="push()"> Push</button> 
                                        ...
                                        <button  onclick="envoyer()" type="submit" class="btn button1 text-center">Valider</button>
                        </div>
                    </div>
            </div>
            <div class="col-md-4">
    ...
    <script language="javascript" type="text/javascript">
                    ...
                    var message = {
                            ...
                            content : 'ceci est le contenu du message que je veux tester la taille de mon systeme de chat',
