                                    ...
                                    <form action="{{ route('date.store') }}" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label for="recipient-name" class="col-form-label">Nom de l'Edition:</label>
                                                <input type="text" name="designation" placeholder="Nom de l'Edition" class="form-control" id="recipient-name">
                                            </div>
                                              <div class="form-group">
                        ...
                        <div class="col-6">
                         <div class="card">
                             <div class="card-body">
                               <div class="row mb-1">
                                 <div class="col">
                                     <h4 class="mb-0 number-font">{{$date->designation}}</h4>
     
                                     <p style="color: #808080!important;" class="mb-1"> DEBUT : {{$date->date_debut}}</p>
                                     <p style="color: #808080!important;" class="mb-1"> FIN : {{$date->date_fin}}</p>
                               ...
                               <span class="fs-12 text-muted"> <strong>Status : </strong><i class="mdi mdi-traffic-light"></i> <span class="text-muted fs-12 ml-0 mt-1 text-success">A venir</span></span>
                               <a href="#"  class="text-primary  mb-1 float-right" data-toggle="modal"
                                   data-target="#exampleModalSettings">Afficher details</a>
                                  
                               <div class="modal" id="exampleModalSettings" tabindex="1" role="dialog"
                               aria-labelledby="exampleModalSettings" aria-hidden="true">
                                   <div class="modal-dialog" role="document">
                                         <div class="modal-content">
                                     <div class="modal-header">
                                     <h5 class="modal-title" id="exampleModalSettings">{{$date->designation}}</h5>
                                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
