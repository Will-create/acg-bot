...
@section('page-header')
				...
				<div class="page-header">
					<div>
			            <h1 class="page-title">Détails d'un message</h1>
						<ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('accueil')}}">Accueil</a></li>
                        <li class="breadcrumb-item" aria-current="page"><a href="{{route('servicefoot.index')}}">Message</a></li>
							<li class="breadcrumb-item active" aria-current="page">{{$sevicefoot->auteur->titre}} {{$sevicefoot->auteur->nom}}</li>
						</ol>
					</div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="float-left">
                                <h3 class="card-title">Message de  <a class="text-dark" href="{{route('utilisateurs.show',$commentaire->auteur->uuid)}}">{{$servicefoot->auteur->nom}} {{$servicefoot->auteur->prenom}}</a></h3>
                            </div>
                        ...
                        <div class="card-body wideget-user-contact">
                                <div class="card-body">
                                    <div class="wideget-user text-center">
                                        <div class="wideget-user-desc">
                                            ...
                                            <div class="user-wrap">
                                                <a class="text-dark" href="{{ route('utilisateurs.show', $commentaire->auteur->uuid) }}" data-toggle="tooltip" data-placement="top" title="Cliquer pour voir les details">
                                                    <h6 class="text-muted mb-4">{{$servicefoot->auteur->nom. ' ' . $servicefoot->auteur->prenom}} ({{$servicefoot->auteur->role->designation}})</h6>
                                                </a> <br>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="wideget-user-desc">
                                            <div class="wideget-user-img">
                                                <dt>Message concerné:</dt>
                                            </div>
                                            <div class="user-wrap">
                                                    Contenu d'origine : <h6 class="mb-1">{{$servicefoot->sms->contenu_entree}}</h6>
                                                 <br>
                                            </div>
                                        </div>
                                        <dt>Commentaire:</dt>
                                        <h6 class="text-muted mb-4">Envoyé le : {{formatDate($servicefoot->created_at)}}</h6>
                                        <dd>  <a class="text-dark" href="{{route('commentaires.show', $commentaire->uuid)}}">{{ucFirst($servicefoot->message)}}</a></dd>
                                    </div>
                                </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="tab-content">
                        <div class="tab-pane active show" id="tab-51">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="page-title">Autres message  de même nature</h3>
                                    @foreach($autres as $autre)
                                    @if ($autre->id != $servicefoot->id)
                                    ...
                                    @endif
                                    @if ($autres->count() == 1)
                                    <span class="">Aucun autre message n'est disponible que celui-la</span>
                                    @endif
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p> Etes-vous sûr de vouloir supprimer ce message ?
                            </p>
                        </div>
